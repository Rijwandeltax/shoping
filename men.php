	...
	<div class="container">
						...
						<div class="ecommerce_dres-type">
							<ul>
                             ...
                             <?php             
											   ...
											   include("data.php"); 
                                               $rs=mysql_query("select * from subcategory where categoryname='Mens wear'");
                                                 while($r=mysql_fetch_array($rs)){
												$cat=$r[1];
                                                 ?>
                                             
                                         
								<li><a href="men.php?id1=<?=$r[1]?>&id2=<?=$r[3]?>"><?=$r[3]?></a></li>
								<?php
												}
												?>
							</ul>
			...
			<div class="w3ls_dresses_grid_left_grid">
				...
				<div class="w3ls_dresses_grid_left_grid_sub">
					<div class="ecommerce_color ecommerce_size">
						<ul>
							<li><a href="men.php?id3=<?=$cat?>&id4=Low">Price-Low to High</a></li>
                            <li><a href="men.php?id3=<?=$cat?>&id4=High">Price-High to Low</a></li>
                            <li><a href="#">Popularity</a></li>
							<li><a href="men.php?id3=<?=$cat?>&id4=date">Newest</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="col-md-8 col-sm-8 women-dresses">
			<div class="women-set1">
             ...
             <?php
			 include("data.php");
             $rs=mysql_query("select * from product where categoryname='Mens wear' AND subcategoryname='shoes'");
			  while($r=mysql_fetch_array($rs)){
